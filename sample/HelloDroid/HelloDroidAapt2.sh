...
${AAPT2} link -v \
    --auto-add-overlay \
    --static-lib \
    -o ${OUT_ANDROID_APK}/HelloDroidLib.apk \
...
# R file will be regenerated by App
rm -v ${OUT_JAVA_CLASSES}/HelloDroidLib/hello/droid/common/R.class
rm -v ${OUT_JAVA_CLASSES}/HelloDroidLib/hello/droid/common/R'$'*.class
jar \
...
${AAPT2} link -v \
    ...
    --manifest App/AndroidManifest-AAPT2.xml \
...
javac \
    -bootclasspath ${PLATFORM} \
    -cp ${OUT_JAVA_JAR}/HelloDroid.jar:${JUNIT}:${ANDROID_SUPPORT_TEST} \
    -sourcepath ${OUT_ANDROID_JAVA}/HelloDroid/:${OUT_ANDROID_JAVA}/HelloDroidInstrumentationTest/ \
